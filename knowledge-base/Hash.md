...
---
#### Perché un hash sicuro non basta a proteggere le password

Questo è il punto centrale dimostrato nelle challenge di cracking: un algoritmo di hash **crittograficamente robusto** (es. SHA256, senza collisioni note) protegge comunque **solo l'algoritmo**, non la scelta della password.
...
#### Perché per le password si usano funzioni diverse da MD5/SHA (bcrypt, scrypt, Argon2)
