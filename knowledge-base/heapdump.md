...
Gli heap dump sono pensati come strumenti di **debugging e diagnostica** (analisi di memory leak, profiling delle performance), non per essere esposti pubblicamente.
