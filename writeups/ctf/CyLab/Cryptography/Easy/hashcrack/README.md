...
#### Descrizione
Un'azienda ha memorizzato un messaggio segreto su un server che è stato violato a causa dell'amministratore utilizzando password debolmente hash. È possibile ottenere l'accesso al segreto memorizzato all'interno del server?
